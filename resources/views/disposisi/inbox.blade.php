...
@section('content')
    <div class="d-flex flex-column flex-lg-row align-items-start align-items-lg-center justify-content-between gap-2 mb-3">
        <div>
            <div class="h4 mb-0">Disposisi Masuk</div>
            <div class="text-muted">Daftar disposisi yang kamu terima.</div>
        </div>
        <div class="d-flex gap-2">
            @if(in_array($role, ['kasatker', 'kaskogartap'], true))
                <a href="{{ route('disposisi.outbox') }}" class="btn btn-outline-secondary">
        ...
        <div class="card-body">
            <form method="get" class="row g-2 align-items-center">
                <div class="col-12 col-lg-5">
                    <input name="q" value="{{ $q ?? '' }}" placeholder="Cari nomor/perihal/pengirim/dari/status/instruksi..." class="form-control">
                </div>
                ...
                <div class="col-12 col-lg-2 d-flex gap-2">
                    ...
                    <a href="{{ route('disposisi.inbox') }}" class="btn btn-outline-secondary" title="Reset" aria-label="Reset">
        ...
        <div class="table-responsive">
            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <div class="d-inline-flex gap-1">
                                    <a href="{{ route('surat-masuk.show', $item->suratMasuk) }}" class="btn btn-sm btn-outline-primary" title="Detail Surat" aria-label="Detail Surat">
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="text-center text-muted py-5">Belum ada disposisi masuk.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
