...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-light">
        @php($unreadNotifikasi = auth()->user()->notifikasis()->where('status', 'unread')->count())
        ...
        <div class="offcanvas offcanvas-start bg-navy text-white d-lg-none" tabindex="-1" id="sidebarMobile" aria-labelledby="sidebarMobileLabel">
            <div class="offcanvas-header">
                <h5 class="offcanvas-title" id="sidebarMobileLabel">Kaskogartap</h5>
            ...
            <div class="offcanvas-body">
                ...
                <div class="small text-white-50 mb-2 text-center">{{ '@'.auth()->user()->username }} • Kaskogartap</div>
                ...
                <div class="nav nav-pills flex-column gap-1">
                    ...
                    <a class="nav-link sidebar-link d-flex align-items-center gap-2 {{ request()->routeIs('disposisi.outbox') ? 'active' : '' }}" href="{{ route('disposisi.outbox') }}">
                        <i class="bi bi-send-check"></i>
                        <span>Disposisi Keluar</span>
                    </a>
                    <a class="nav-link sidebar-link d-flex align-items-center gap-2 {{ request()->routeIs('notifikasi.*') ? 'active' : '' }}" href="{{ route('notifikasi.index') }}">
                        <i class="bi bi-bell"></i>
                        <span>Notifikasi</span>
                        @if($unreadNotifikasi > 0)
                            <span class="badge rounded-pill text-bg-warning ms-auto">{{ $unreadNotifikasi }}</span>
                        @endif
                    </a>
                </div>
            </div>
