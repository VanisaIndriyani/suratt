...
@section('content')
    <div class="d-flex align-items-start justify-content-between gap-2 mb-3">
        <div>
            <div class="h4 mb-0">Ubah Surat Keluar</div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            <form method="post" action="{{ route('surat-keluar.update', $item) }}" enctype="multipart/form-data" class="vstack gap-3">
                @csrf
                @method('PUT')
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input name="tujuan" value="{{ old('tujuan', $item->tujuan) }}" class="form-control" required>
                ...
                <div>
                    ...
                    @if($item->file_surat)
                        <div class="small mt-2">
                            <a class="link-primary text-decoration-none" href="{{ route('surat-keluar.download', $item) }}">Download file saat ini</a>
                        </div>
                    @endif
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('surat-keluar.show', $item) }}" class="btn btn-outline-secondary">Batal</a>
                </div>
            </form>
        </div>
    </div>
