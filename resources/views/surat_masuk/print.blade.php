...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Cetak Surat Masuk - {{ $item->nomor_surat }}</title>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4 p-md-5">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <div class="h5 mb-0">Surat Masuk</div>
                    ...
                    <div class="mt-4">
                        <div class="fw-semibold">Riwayat Disposisi</div>
                        <div class="table-responsive mt-2">
                            <table class="table table-bordered table-sm align-middle mb-0">
                                <thead class="table-light">
                                    <tr>
                                        <th style="width: 120px;">Tanggal</th>
                                        <th style="width: 160px;">Dari</th>
                                        <th style="width: 160px;">Ke</th>
                                        <th>Instruksi</th>
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="5" class="text-center text-muted py-4">Tidak ada disposisi.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
